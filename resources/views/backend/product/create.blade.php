...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="{{route('product.store')}}">
      ...
      <div class="form-group">
        <label for="weight" class="col-form-label">Weight(gam) <span class="text-danger">*</span></label>
        <input id="weight" type="number" name="weight" min="0" placeholder="Enter weight" value="{{old('weight')}}" class="form-control">
        @error('weight')
        <span class="text-danger">{{$message}}</span>
        @enderror
      </div>
