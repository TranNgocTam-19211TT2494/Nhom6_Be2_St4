...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Comments List</h6>
      <a href="{{route('comment.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Comment</a>
    </div>
  <div class="card-header py-3">
          ...
          <tr>
            ...
            <td>
              <div class="row">
                ...
                @if($comment->replied_comment !== NULL)
                <div class="col-md-6">
                  <div class="check">
                    <i class="fas fa-check-circle " style="font-size: 20px; font-size: 33px;background: green;border-radius: 50%;color: greenyellow;"></i>
                  </div>
                </div>
                @endif
              </div>
