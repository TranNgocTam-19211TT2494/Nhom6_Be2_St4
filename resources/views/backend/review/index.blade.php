...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <!-- <a href="{{route('rate.edit',$review->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a> -->
              <form method="POST" action="{{route('rate.destroy',[$review->id])}}" style="text-align: center;">
                @csrf
                @method('delete')
      ...
      <span style="float:right">{{$product_reviews->links()}}</span>
      @else
